...
function Signup() {
  const { user, signUp, loading, error, hasSupabaseConfig } = useAuth();
  const { t } = useLocale();
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <h2 className="text-3xl font-semibold text-white">
                Construa sua central de analytics em minutos.
              </h2>
              <p className="text-sm text-slate-300">
                Tenha integrações prontas com Emarsys, GA4 e CRM com segurança.
              </p>
            </div>
          </div>
          <div className="space-y-3 text-sm text-slate-300">
            <p>• Onboarding guiado</p>
            <p>• Conectores nativos e seguros</p>
            <p>• Playbooks de campanhas inteligentes</p>
          </div>
        </aside>
